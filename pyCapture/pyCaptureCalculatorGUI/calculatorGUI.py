...
reTitle_text.configure(font='Helvetica 18 bold',width=messageWidth,bg=titleBG)
...
instructions1_text.configure(font='Courier 16',width=messageWidth,bg=instructionsBG)
...
instructions2_text.configure(font='Courier 16',width=messageWidth,bg=instructionsBG)
...
instructions3_text.configure(font='Courier 16',width=messageWidth,bg=instructionsBG)
